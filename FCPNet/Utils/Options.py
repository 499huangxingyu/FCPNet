...
def FCPNet_args():
    ...
    parser.add_argument('--save', type=str, default='./FCPNet/DenseNet/', help='Result saving')
    parser.add_argument('--check_save', type=str, default='./FCPNet/DenseNet/checkpoint', help='checkpoint saving')
    parser.add_argument('--model_save', type=str, default='./FCPNet/DenseNet/model', help='model saving')
    parser.add_argument('--test_save', type=str, default='./FCPNet/DenseNet/test', help='model saving')
